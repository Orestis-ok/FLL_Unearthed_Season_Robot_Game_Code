...
#### Mission 13 "Ανακατασκευή αγάλματος" ####
    ...
    PointTurn_Angle(350, 500, 34, True, Stop.BRAKE) # Στροφή δεξιά 34 μοιρες
    ...
    MoveStraight_Distance(200,700,-90,True,True,Stop.BRAKE) # Συνεχίζει ανάποδα, πλησιάζει το Άγαλμα

    rightArm.run_time(400, 600, then=Stop.BRAKE, wait=True)  # Ανεβάζει Βραχίονα (speed, duration)
