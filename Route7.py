...
#### Mission 13 "Ανακατασκευή αγάλματος" ####
    ...
    leftArm.run_time(-1000, 2300, then=Stop.BRAKE, wait=True) # περιστρέφεται ο μηχανισμός για να αναποδογυρίσει τη Ζυγαριά
    MoveStraight_Distance(400,600,-100,True,True,Stop.BRAKE) # Μικρή όπισθεν για να τραβήξει τον Μοχλό και να καθαρίσει την Άμμο

    MoveSteering_Seconds(-950, 10, 1200) # Επιστροφή στη Βάση 
    wait(200)         
